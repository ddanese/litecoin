# Support for Output Descriptors in zDatacoin Core

Since zDatacoin Core v0.17, there is support for Output Descriptors. This is a
...
on zDatacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing zDatacoin Core wallets, a convenience function `combo` is
