...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zdatacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zdatacoin-tx [options] <hex-tx> [commands]  Update hex-encoded zdatacoin transaction\n" +
            "or:     zdatacoin-tx [options] -create [commands]   Create hex-encoded zdatacoin transaction\n" +
            "\n";
