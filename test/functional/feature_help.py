...
"""Verify that starting zdatacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zdatacoin with -h for help text")
        ...
        self.log.info("Start zdatacoin with -version for version information")
        ...
        self.log.info("Start zdatacoind with -fakearg to make sure it does not start")
